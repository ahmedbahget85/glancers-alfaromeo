...
if ( $max_value && $min_value === $max_value ) {
	...
	$label = ! empty( $args['product_name'] ) ? sprintf( esc_attr__( '%s quantity', 'etienne' ), strip_tags( $args['product_name'] ) ) : '';
	?>
    <div class="eltdf-quantity-buttons quantity">
        ...
        <input type="text"
                ...
                title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'etienne' ) ?>"
