...
if (!class_exists('EtienneElatedClassFullscreenNavigationWalker')) {
	class EtienneElatedClassFullscreenNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				if($args->has_children) {
					$item_output .= '<i class="eltdf-fullscreen-menu-arrow arrow_carrot-right"></i>';
				}
				$item_output .= '</a>';
			}
