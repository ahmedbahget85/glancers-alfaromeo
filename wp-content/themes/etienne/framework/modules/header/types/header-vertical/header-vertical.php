...
class HeaderVertical extends HeaderType {
	...
	public function loadTemplate( $parameters = array() ) {
		$parameters['holder_class'] = etienne_elated_vertical_header_holder_class();
		
		$parameters = apply_filters( 'etienne_elated_filter_header_vertical_parameters', $parameters );
