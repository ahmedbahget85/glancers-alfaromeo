...
class EtienneElatedClassBlogListWidget extends EtienneElatedClassWidget {
	public function __construct() {
		parent::__construct(
			'eltdf_blog_list_widget',
			esc_html__( 'Etienne Blog List Widget', 'etienne' ),
			array( 'description' => esc_html__( 'Display a list of your blog posts', 'etienne' ) )
		);
		...
		$this->params = array(
			...
			array(
				...
				'options' => array(
					...
					'minimal' => esc_html__( 'Minimal', 'etienne' )
				)
			),
			array(
				'type'  => 'textfield',
				'name'  => 'number_of_posts',
				'title' => esc_html__( 'Number of Posts', 'etienne' )
			),
			array(
				'type'    => 'dropdown',
			...
			array(
				'type'    => 'dropdown',
				'name'    => 'orderby',
				'title'   => esc_html__( 'Order By', 'etienne' ),
				'options' => etienne_elated_get_query_order_by_array()
			),
			array(
				'type'    => 'dropdown',
				'name'    => 'order',
				'title'   => esc_html__( 'Order', 'etienne' ),
				'options' => etienne_elated_get_query_order_array()
			),
			array(
				'type'        => 'textfield',
				'name'        => 'category',
				'title'       => esc_html__( 'Category Slug', 'etienne' ),
				'description' => esc_html__( 'Leave empty for all or use comma for list', 'etienne' )
			),
			array(
				'type'    => 'dropdown',
				'name'    => 'title_tag',
			...
			array(
				...
				'title'   => esc_html__( 'Title Text Transform', 'etienne' ),
	...
	public function widget( $args, $instance ) {
		...
		echo '<div class="widget eltdf-blog-list-widget" ' . etienne_elated_get_inline_style( $widget_styles ) . '>';
