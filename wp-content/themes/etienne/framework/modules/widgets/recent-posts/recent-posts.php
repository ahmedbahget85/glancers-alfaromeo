...
class EtienneElatedClassRecentPosts extends EtienneElatedClassWidget {
	public function __construct() {
		parent::__construct(
			'eltdf_recent_posts',
			esc_html__( 'Etienne Recent Posts', 'etienne' ),
			array( 'description' => esc_html__( 'Select recent posts that you would like to display', 'etienne' ) )
		);
	...
	public function widget( $args, $instance ) {
        ...
        $html = '<div class="widget eltdf-recent-post-widget" ' . etienne_elated_get_inline_style( $widget_styles ) . '>';
        ...
        if ( $query->have_posts() ) {
            ...
            $html .= esc_html__('Sorry, there are no posts matching your criteria', 'etienne');
        }
