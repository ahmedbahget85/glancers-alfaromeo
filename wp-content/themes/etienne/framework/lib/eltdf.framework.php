...
/*
   Class: EtienneElatedClassFramework
...
class EtienneElatedClassFramework {
	...
	private function __construct() {
		$this->eltdOptions         = EtienneElatedClassOptions::get_instance();
		$this->eltdMetaBoxes       = EtienneElatedClassMetaBoxes::get_instance();
		$this->eltdTaxonomyOptions = EtienneElatedClassTaxonomyOptions::get_instance();
		$this->eltdUserOptions     = EtienneElatedClassUserOptions::get_instance();
		$this->eltdDashboardOptions = EtienneElatedClassDashboardOptions::get_instance();
	}
	...
	public function setSkin( EtienneElatedClassSkinAbstract $skinObject ) {
		$this->skin = $skinObject;
	}
}

/**
 * Class EtienneElatedClassSkinManager
 *
...
class EtienneElatedClassSkinManager {
	...
	/**
	 * @see EtienneElatedClassSkinManager::setSkin()
	 */
	...
	private function setSkin( $skinName = ELATED_PROFILE_SLUG ) {
		if ( $skinName !== '' ) {
			if ( file_exists( get_template_directory() . '/framework/admin/skins/' . $skinName . '/skin.php' ) ) {
				...
				$skinName = ucfirst( $skinName ) . esc_html__( 'Skin', 'etienne' );
...
/**
 * Class EtienneElatedClassSkinAbstract
 *
 * Abstract class that each skin class must extend
 */
abstract class EtienneElatedClassSkinAbstract {
	/**
	 * @var string
	 */
	protected $skinName;
	...
	public function loadTemplatePart( $template, $params = array() ) {
		...
		if ( $template !== '' ) {
			include( etienne_elated_find_template_path( 'framework/admin/skins/' . $this->skinName . '/templates/' . $template . '.php' ) );
		}
	}
	...
	public function setShortcodeJSParams() { ?>
		<script>
			window.eltdSCIcon = '<?php echo etienne_elated_get_skin_uri() . '/assets/img/admin-logo-icon.png'; ?>';
			window.eltdSCLabel = '<?php echo esc_html( ucfirst( $this->skinName ) ); ?> <?php esc_html_e( 'Shortcodes', 'etienne' ) ?>';
		</script>
	<?php }
...
/*
   Class: EtienneElatedClassOptions
...
class EtienneElatedClassOptions {
	...
	public function getOptionValue( $key ) {
		...
		if ( array_key_exists( $key, $etienne_elated_global_options ) ) {
			return $etienne_elated_global_options[ $key ];
...
/*
   Class: EtienneElatedClassAdminPage
   A class that initializes Elated Admin Page
*/
class EtienneElatedClassAdminPage implements iEtienneElatedInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $slug;
	public $title;
	...
	function __construct( $slug = "", $title = "", $icon = "" ) {
		$this->layout  = array();
		$this->factory = new EtienneElatedClassFieldFactory();
		$this->slug    = $slug;
		$this->title   = $title;
		$this->icon    = $icon;
	}
	...
	public function renderChild( iEtienneElatedInterfaceRender $child ) {
		$child->render( $this->factory );
	}
}

/*
   Class: EtienneElatedClassMetaBoxes
...
/*
   Class: EtienneElatedClassMetaBox
   A class that initializes Elated Meta Box
*/
class EtienneElatedClassMetaBox implements iEtienneElatedInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $scope;
	public $title;
	...
	public function setTitle( $label ) {
		...
		return $etienne_elated_global_Framework->getSkin()->getSkinLabel() . ' ' . $label;
	}
}

/*
   Class: EtienneElatedClassTaxonomyOptions
   A class that initializes EtienneElatedClass Taxonomy Options
*/
class EtienneElatedClassTaxonomyOptions {
	private static $instance;
...
/*
   Class: EtienneElatedClassTaxonomyOption
   A class that initializes EtienneElatedClass Taxonomy Option
*/
class EtienneElatedClassTaxonomyOption implements iEtienneElatedInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $scope;
	...
	function __construct( $scope = "" ) {
		$this->layout  = array();
		$this->factory = new EtienneElatedClassTaxonomyFieldFactory();
		$this->scope   = $scope;
	}
...
/*
   Class: EtienneElatedClassUserOptions
   A class that initializes EtienneElatedClass User Options
*/
class EtienneElatedClassUserOptions {
	private static $instance;
	public $userOptions;
...
/*
   Class: EtienneElatedClassUserOption
   A class that initializes EtienneElatedClass User Option
*/
class EtienneElatedClassUserOption implements iEtienneElatedInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $scope;
	...
	function __construct( $scope = "" ) {
		$this->layout  = array();
		$this->factory = new EtienneElatedClassUserFieldFactory();
		$this->scope   = $scope;
	}
...
/*
   Class: EtienneElatedClassDashboardOptions
   A class that initializes EtienneElatedClass Dashboard Options
*/
class EtienneElatedClassDashboardOptions {
	private static $instance;
...
/*
   Class: EtienneElatedClassDashboardOption
   A class that initializes EtienneElatedClass Dashboard Option
*/
class EtienneElatedClassDashboardOption implements iEtienneElatedInterfaceLayoutNode {
	public $layout;
	private $factory;
	
	function __construct() {
		$this->layout        = array();
		$this->factory       = new EtienneElatedClassDashboardFieldFactory();
	}
...
if ( ! function_exists( 'etienne_elated_init_framework_variable' ) ) {
	function etienne_elated_init_framework_variable() {
		global $etienne_elated_global_Framework;
		
		$etienne_elated_global_Framework = EtienneElatedClassFramework::get_instance();
		$eltdSkinManager                 = new EtienneElatedClassSkinManager();
		$etienne_elated_global_Framework->setSkin( $eltdSkinManager->getSkin() );
	}
	
	add_action( 'etienne_elated_action_before_options_map', 'etienne_elated_init_framework_variable' );
}
?>