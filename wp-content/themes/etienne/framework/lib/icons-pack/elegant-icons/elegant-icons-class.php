...
if ( ! function_exists( 'etienne_elated_add_font_elegant_icon_pack' ) ) {
	function etienne_elated_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new EtienneElatedClassIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'etienne_elated_filter_add_icon_pack_into_collection', 'etienne_elated_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'etienne_elated_add_font_elegant_icon_pack_option' ) ) {
	function etienne_elated_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'etienne' );
		
		return $options;
	}
	
	add_filter( 'etienne_elated_filter_add_icon_pack_into_options', 'etienne_elated_add_font_elegant_icon_pack_option' );
	add_filter( 'etienne_elated_filter_add_icon_pack_into_social_options', 'etienne_elated_add_font_elegant_icon_pack_option' );
}

class EtienneElatedClassIconsFontElegant implements iEtienneElatedInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
