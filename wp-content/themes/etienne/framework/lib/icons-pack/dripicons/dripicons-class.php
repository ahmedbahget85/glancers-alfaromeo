...
if ( ! function_exists( 'etienne_elated_add_dripicons_icon_pack' ) ) {
	function etienne_elated_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new EtienneElatedClassDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'etienne_elated_filter_add_icon_pack_into_collection', 'etienne_elated_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'etienne_elated_add_dripicons_icon_pack_option' ) ) {
	function etienne_elated_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'etienne' );
		
		return $options;
	}
	
	add_filter( 'etienne_elated_filter_add_icon_pack_into_options', 'etienne_elated_add_dripicons_icon_pack_option' );
}

class EtienneElatedClassDripicons implements iEtienneElatedInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
