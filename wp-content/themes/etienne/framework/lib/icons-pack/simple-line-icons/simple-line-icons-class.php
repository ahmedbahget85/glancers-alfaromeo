...
if ( ! function_exists( 'etienne_elated_add_simple_line_icon_pack' ) ) {
	function etienne_elated_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new EtienneElatedClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'etienne_elated_filter_add_icon_pack_into_collection', 'etienne_elated_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'etienne_elated_add_simple_line_icon_pack_option' ) ) {
	function etienne_elated_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'etienne' );
		
		return $options;
	}
	
	add_filter( 'etienne_elated_filter_add_icon_pack_into_options', 'etienne_elated_add_simple_line_icon_pack_option' );
	add_filter( 'etienne_elated_filter_add_icon_pack_into_social_options', 'etienne_elated_add_simple_line_icon_pack_option' );
}

class EtienneElatedClassSimpleLineIcons implements iEtienneElatedInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'etienne'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'etienne'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'etienne'),
            'icon-social-facebook'    => esc_html__('Facebook', 'etienne'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'etienne'),
            'icon-social-github'      => esc_html__('Github', 'etienne'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'etienne'),
            'icon-social-instagram'   => esc_html__('Instagram', 'etienne'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'etienne'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'etienne'),
            'icon-social-reddit'      => esc_html__('Reddit', 'etienne'),
            'icon-social-skype'       => esc_html__('Skype', 'etienne'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'etienne'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'etienne'),
            'icon-social-spotify'     => esc_html__('Spotify', 'etienne'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'etienne'),
            'icon-social-twitter'     => esc_html__('Twitter', 'etienne'),
            'icon-social-youtube'     => esc_html__('Youtube', 'etienne')
        );
    }
