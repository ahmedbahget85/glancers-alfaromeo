...
if ( ! function_exists( 'etienne_elated_add_linear_icon_pack' ) ) {
	function etienne_elated_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new EtienneElatedClassLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'etienne_elated_filter_add_icon_pack_into_collection', 'etienne_elated_add_linear_icon_pack' );
}

if ( ! function_exists( 'etienne_elated_add_linear_icon_pack_option' ) ) {
	function etienne_elated_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'etienne' );
		
		return $options;
	}
	
	add_filter( 'etienne_elated_filter_add_icon_pack_into_options', 'etienne_elated_add_linear_icon_pack_option' );
}

class EtienneElatedClassLinearIcons implements iEtienneElatedInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
