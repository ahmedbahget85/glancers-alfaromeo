...
if ( ! function_exists( 'etienne_elated_add_linea_icon_pack' ) ) {
	function etienne_elated_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new EtienneElatedClassLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'etienne_elated_filter_add_icon_pack_into_collection', 'etienne_elated_add_linea_icon_pack' );
}

if ( ! function_exists( 'etienne_elated_add_linea_icon_pack_option' ) ) {
	function etienne_elated_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'etienne' );
		
		return $options;
	}
	
	add_filter( 'etienne_elated_filter_add_icon_pack_into_options', 'etienne_elated_add_linea_icon_pack_option' );
}

class EtienneElatedClassLineaIcons implements iEtienneElatedInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
