...
if ( ! function_exists( 'etienne_elated_add_ion_icon_pack' ) ) {
	function etienne_elated_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new EtienneElatedClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'etienne_elated_filter_add_icon_pack_into_collection', 'etienne_elated_add_ion_icon_pack' );
}

if ( ! function_exists( 'etienne_elated_add_ion_icon_pack_option' ) ) {
	function etienne_elated_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'etienne' );
		
		return $options;
	}
	
	add_filter( 'etienne_elated_filter_add_icon_pack_into_options', 'etienne_elated_add_ion_icon_pack_option' );
	add_filter( 'etienne_elated_filter_add_icon_pack_into_social_options', 'etienne_elated_add_ion_icon_pack_option' );
}

class EtienneElatedClassIonIcons implements iEtienneElatedInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
