...
<div class="form-container">
    <div class="left" style="background-image: url('<?php bloginfo('template_directory'); ?>/asset/images/stelvio-12.png');">
        <div class="head">
            <span class="font-sm light uppercase">Alfa Romeo</span>
            <h1 class="bold">test drive</h1>
        </div>
    </div>
    <div class="right">
                ...
                <?php } ?>
                    <div class="form-section-inner">
                        <div class="form-head">
                            ...
                            <!-- <p class="light">Which Car Model You’re Interested to Test?</p> -->
                        </div>
                        <div class="content">
...
if(isset($_POST['module-name'])){
    ...
    global $wpdb;
    $wpdb->show_errors();
    $sql = $wpdb->insert('test_drive_request',$data);
}
